...
public class SubscriptionData implements com.sforce.ws.bind.XMLizable {
  ...
  private com.zuora.api.object.RatePlanData[] RatePlanData = new com.zuora.api.object.RatePlanData[0];
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
    ...
    if (__typeMapper.isElement(__in, Subscription__typeInfo)) {
      setSubscription((com.zuora.api.object.Subscription)__typeMapper.readObject(__in, Subscription__typeInfo, com.zuora.api.object.Subscription.class));
    }
    __in.peekTag();
