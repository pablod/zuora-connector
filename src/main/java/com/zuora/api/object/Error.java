...
public class Error implements com.sforce.ws.bind.XMLizable {
  ...
  private com.zuora.api.object.ErrorCode Code;

  public com.zuora.api.object.ErrorCode getCode() {
    return Code;
  }

  

  public void setCode(com.zuora.api.object.ErrorCode Code) {
    this.Code = Code;
    Code__is_set = true;
  }
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
    ...
    if (__typeMapper.isElement(__in, Code__typeInfo)) {
      setCode((com.zuora.api.object.ErrorCode)__typeMapper.readObject(__in, Code__typeInfo, com.zuora.api.object.ErrorCode.class));
    }
    __in.peekTag();
