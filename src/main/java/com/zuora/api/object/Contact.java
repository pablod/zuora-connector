    ...
    implements Serializable
{
    ...
    @XmlElement(name = "OtherPhoneType", nillable = true)
    protected String otherPhoneType;
    @XmlElement(name = "PersonalEmail", nillable = true)
    ...
    @XmlElement(name = "WorkEmail", nillable = true)
    protected String workEmail;
    @XmlElement(name = "WorkPhone", nillable = true)
