...
public class SubscribeResult implements com.sforce.ws.bind.XMLizable {
  ...
  private com.zuora.api.object.InvoiceData[] InvoiceData = new com.zuora.api.object.InvoiceData[0];

  public com.zuora.api.object.InvoiceData[] getInvoiceData() {
    return InvoiceData;
  }

  

  public void setInvoiceData(com.zuora.api.object.InvoiceData[] InvoiceData) {
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
    ...
    if (__typeMapper.isElement(__in, InvoiceData__typeInfo)) {
      setInvoiceData((com.zuora.api.object.InvoiceData[])__typeMapper.readObject(__in, InvoiceData__typeInfo, com.zuora.api.object.InvoiceData[].class));
    }
    __in.peekTag();
