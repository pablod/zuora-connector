...
public class SubscribeResponse_element implements com.sforce.ws.bind.XMLizable {
  ...
  private com.sforce.soap.SubscribeResult[] result = new com.sforce.soap.SubscribeResult[0];

  public com.sforce.soap.SubscribeResult[] getResult() {
    return result;
  }

  

  public void setResult(com.sforce.soap.SubscribeResult[] result) {
    this.result = result;
    result__is_set = true;
  }
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
    ...
    if (__typeMapper.isElement(__in, result__typeInfo)) {
      setResult((com.sforce.soap.SubscribeResult[])__typeMapper.readObject(__in, result__typeInfo, com.sforce.soap.SubscribeResult[].class));
    }
  }
