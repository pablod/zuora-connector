 ...
 */
public class GenerateResponse_element implements com.sforce.ws.bind.XMLizable {

  /**
   * Constructor
   */
  public GenerateResponse_element() {
  }
  ...
  private com.sforce.soap.SaveResult[] result = new com.sforce.soap.SaveResult[0];

  public com.sforce.soap.SaveResult[] getResult() {
    return result;
  }

  

  public void setResult(com.sforce.soap.SaveResult[] result) {
    this.result = result;
    result__is_set = true;
  }
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
    ...
    if (__typeMapper.isElement(__in, result__typeInfo)) {
      setResult((com.sforce.soap.SaveResult[])__typeMapper.readObject(__in, result__typeInfo, com.sforce.soap.SaveResult[].class));
    }
  }

  public String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder();
    sb.append("[GenerateResponse_element ");
