...
public class Subscribe_element implements com.sforce.ws.bind.XMLizable {
  ...
  private com.sforce.soap.SubscribeRequest[] subscribes = new com.sforce.soap.SubscribeRequest[0];

  public com.sforce.soap.SubscribeRequest[] getSubscribes() {
    return subscribes;
  }

  

  public void setSubscribes(com.sforce.soap.SubscribeRequest[] subscribes) {
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
    ...
    if (__typeMapper.isElement(__in, subscribes__typeInfo)) {
      setSubscribes((com.sforce.soap.SubscribeRequest[])__typeMapper.readObject(__in, subscribes__typeInfo, com.sforce.soap.SubscribeRequest[].class));
    }
  }
