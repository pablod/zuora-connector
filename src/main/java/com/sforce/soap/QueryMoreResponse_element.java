...
public class QueryMoreResponse_element implements com.sforce.ws.bind.XMLizable {
  ...
  private com.sforce.soap.QueryResult result;

  public com.sforce.soap.QueryResult getResult() {
    return result;
  }

  

  public void setResult(com.sforce.soap.QueryResult result) {
    this.result = result;
    result__is_set = true;
  }
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
    ...
    if (__typeMapper.verifyElement(__in, result__typeInfo)) {
      setResult((com.sforce.soap.QueryResult)__typeMapper.readObject(__in, result__typeInfo, com.sforce.soap.QueryResult.class));
    }
  }
