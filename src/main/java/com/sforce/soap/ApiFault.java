...
public class ApiFault extends com.sforce.ws.SoapFaultException implements com.sforce.ws.bind.XMLizable {
  ...
  private com.sforce.soap.ErrorCode FaultCode;
...
@Override
  ...
  public void setFaultCode(com.sforce.soap.ErrorCode FaultCode) {
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
    ...
    if (__typeMapper.isElement(__in, FaultCode__typeInfo)) {
      setFaultCode((com.sforce.soap.ErrorCode)__typeMapper.readObject(__in, FaultCode__typeInfo, com.sforce.soap.ErrorCode.class));
    }
    __in.peekTag();
