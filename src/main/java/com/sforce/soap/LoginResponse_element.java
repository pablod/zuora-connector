...
public class LoginResponse_element implements com.sforce.ws.bind.XMLizable {
  ...
  private com.sforce.soap.LoginResult result;

  public com.sforce.soap.LoginResult getResult() {
    return result;
  }

  

  public void setResult(com.sforce.soap.LoginResult result) {
    this.result = result;
    result__is_set = true;
  }
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
    ...
    if (__typeMapper.isElement(__in, result__typeInfo)) {
      setResult((com.sforce.soap.LoginResult)__typeMapper.readObject(__in, result__typeInfo, com.sforce.soap.LoginResult.class));
    }
  }
