...
public class RatePlanData implements com.sforce.ws.bind.XMLizable {
  ...
  private com.sforce.soap.RatePlanChargeData[] RatePlanChargeData = new com.sforce.soap.RatePlanChargeData[0];

  public com.sforce.soap.RatePlanChargeData[] getRatePlanChargeData() {
    return RatePlanChargeData;
  }

  

  public void setRatePlanChargeData(com.sforce.soap.RatePlanChargeData[] RatePlanChargeData) {
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
    ...
    if (__typeMapper.isElement(__in, RatePlanChargeData__typeInfo)) {
      setRatePlanChargeData((com.sforce.soap.RatePlanChargeData[])__typeMapper.readObject(__in, RatePlanChargeData__typeInfo, com.sforce.soap.RatePlanChargeData[].class));
    }
  }
